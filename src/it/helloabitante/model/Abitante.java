...
public class Abitante {
	...
	public Abitante(String nome, String cognome, String codiceFiscale, int etaParameter, String mottoDiVita) {
		super();
		this.nome = nome;
		this.cognome = cognome;
		this.codiceFiscale = codiceFiscale;
		this.eta = etaParameter;
		this.mottoDiVita = mottoDiVita;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof Abitante) {
			Abitante abitante = (Abitante) obj;
			if (this.idAbitante.equals(abitante.idAbitante))
				return true;
		}
		return false;
	}
